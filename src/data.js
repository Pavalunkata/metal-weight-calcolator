    ...
    return [
        {
            ...
            id: uuidv4(),
            active: true,
            sideA: <input placeholder="Страна А" ></input>,
            sideB: <input placeholder = "Страна B"></input>,
            thicknessA: <input placeholder = "Дебелина" name = "name3"></input>,
            lengh: <input placeholder = "Дължина"></input>,
            many: <input placeholder = "Брой"></input>,
        ...
        },
        {
            ...
            id: uuidv4(),
            active: false,
            sideA: <input placeholder="Диаметър" ></input>,
            thicknessA: <input placeholder = "Дебелина " name = "name3"></input>,
            lengh: <input placeholder = "Дължина"></input>,
            many: <input placeholder = "Брой"></input>,
        },
        ...
        },
        {
            ...
            sideB: <input placeholder = "Страна B"></input>,
            thicknessA: <input placeholder = "Дебелина " name = "name3"></input>,
            thicknessB: <input placeholder = "Дебелина" name = "name3"></input>,
            lengh: <input placeholder = "Дължина"></input>,
            many: <input placeholder = "Брой"></input>,
        },
        {
